...
load("cova_st.RData")
#or load the statio-temporal covariance from an external file
# library(readxl)
# cova_st <- read_excel("Covariogrammi_IMR_new.xlsx")
# names(cova_st) <- c("spacelag", "timelag", "cova")
# select the spatial lags of interest
# cova_st <- cova_st[cova_st$spacelag < 180, ]
